...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({FooNotFoundException.class, ResourceNotFoundException.class})
    public ResponseEntity<ApiErrorResponse> handleNotFound(FooNotFoundException ex, HttpServletRequest req) {
